#!/bin/bash
echo;
echo "Criando rede br11.xml arquivo"
echo;
echo "<network>" > br11.xml;
  echo "<name>br11</name>" >> br11.xml;
  echo "<forward mode='nat'>" >> br11.xml;
    echo "<nat>" >> br11.xml;
      echo "<port start='1024' end='65535'/>" >> br11.xml;
    echo "</nat>" >> br11.xml;
  echo "</forward>" >> br11.xml;
  echo "<bridge name='br11' stp='on' delay='0'/>" >> br11.xml;
  echo "<ip address='192.168.90.50' netmask='255.255.255.254'>" >> br11.xml;
    echo "<dhcp>" >> br11.xml;
      echo "<range start='192.168.90.50' end='192.168.90.51'/>" >> br11.xml;
    echo "</dhcp>" >> br11.xml;
  echo "</ip>" >> br11.xml;
echo "</network>" >> br11.xml;
